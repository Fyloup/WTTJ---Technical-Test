defmodule AtsWeb.Api.JobController do
  ...
  @doc """
  List jobs, optionally filtered by search params.

  Accepts optional query params: `title`, `office`, `contract_type`,
  `work_mode`, `status`. See `Ats.Jobs.list_jobs/1` for details.
  """
  ...
  @doc """
  Returns the available values for each job search filter.
  """
  @spec filters(Plug.Conn.t(), map()) :: Plug.Conn.t()
  def filters(conn, _params) do
    render(conn, :filters, filters: Jobs.filter_options())
  end
